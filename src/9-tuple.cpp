...
int main() {
    ...
    /* 
    Шаблона для девяток простых чисел есть всего 4
    Для каждого шаблона найдены допустимые остатки при делении первого числа на 30030
    Поиск по каждому шаблону запускает в уникальном потоке
    */
